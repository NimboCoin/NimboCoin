...
namespace WalletConfig
{
    ...
    const std::string_view addressPrefix = "Nimb";

    /* Your coins 'Ticker', e.g. Monero = XMR, Bitcoin = BTC */
    const std::string ticker = "NIMB";
    ...
    const std::string daemonName = "NimboCoind";
    ...
    /* The name of service/walletd, the programmatic rpc interface to a
       wallet */
    const std::string walletdName = "NimboCoin-service";
